...
const INITIAL_SUPPLY_ERC721 = "56";
const INITIAL_BENZOAPYRENE = "5000"; //ppm - real value * 100 (restrict to two decimal points)
const INITIAL_ARSENIC = "5000"; //ppm - real value * 100 (restrict to two decimal points)
